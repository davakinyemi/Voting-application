...
--
-- Host: localhost
-- Generation Time: Sep 02, 2016 at 02:09 AM
...
--
ALTER TABLE `options`
  MODIFY `optionsid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
-- AUTO_INCREMENT for table `poll`
--
ALTER TABLE `poll`
  MODIFY `pollid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
